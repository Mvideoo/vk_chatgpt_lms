...
const App = () => {
    ...
    useEffect(() => {
        // Вариант «без пересборки» — fetch из public крч просто читает вопрсики из файла questions.json
        fetch("/questions.json")
          ...
          .catch((err) => {
            ...
            // Fallback: можно задать дефолтный набор
            setQuestions([
              "Не удалось загрузить файл. Введите вопрос вручную."
            ]);
          });
    }, []);
